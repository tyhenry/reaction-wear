#define CODE 20000 //length of "mark" in usecs (1 cycle of IR mark @ 38khz ==  26.32 usecs // CODE x 0.038 = # of cycles)
...
void setup(){
  ...
  OCR1A = 104;// = (8000000 / (76000*1)) - 1 == i.e. (8MHz / (76Khz*prescaler) - 1 [because count begins with 0] -  [value must be <65536 for 16bit]
  // turn on CTC mode
  TCCR1B |= (1 << WGM12);
